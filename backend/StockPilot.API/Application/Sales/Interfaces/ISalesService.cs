...
public interface ISalesService
{
    ...
    Task<List<SaleDto>> GetSalesAsync(Guid? branchId, DateTime? startDate, DateTime? endDate, int? paymentMethod = null, int take = 50, CancellationToken cancellationToken = default);
