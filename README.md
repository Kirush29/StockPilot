...
|---|---|---|
| Inventory Management | Inventory Optimization Agent | TBD |
| Sales & Demand | Demand Forecast Agent | TBD |
| Supplier Management | Supplier Evaluation Agent | TBD |
| Procurement Management | Procurement Coordinator Agent | TBD |
